 ...
 */
public class ListarClientesJuridicos extends javax.swing.JFrame {

    /**
     * Creates new form ListarUsuarios
     */
    conexao.ConectaBanco conexao = new ConectaBanco();
    public ListarClientesJuridicos() {
        initComponents();
        preencherTabela("select id, nome_fantasia, razao_social, cep, cnpj, area_atuacao, cidade, rua, numero, telefone, uf from cliente_pessoa_juridica order by nome_fantasia;");
    }
    
    public void preencherTabela(String sql){
        ArrayList linhas = new ArrayList();
        String[] colunas = new String[]{"ID", "Nome fantasia", "Razão social", "CEP", "CNPJ", "Área de atuação", "Cidade", "Rua", "Número", "Telefone", "UF"};
        conexao.conecta();
        ...
        try {
          ...
          do{
          linhas.add(new Object[]{conexao.rs.getInt("id"), conexao.rs.getString("nome_fantasia"), conexao.rs.getString("razao_social"), conexao.rs.getString("cep"), 
          conexao.rs.getString("cnpj"), conexao.rs.getString("area_atuacao"), conexao.rs.getString("cidade"), conexao.rs.getString("rua"), conexao.rs.getString("numero"),
          conexao.rs.getString("telefone"), conexao.rs.getString("uf")});
        ...
        tabelaUsuario.getColumnModel().getColumn(5).setPreferredWidth(150);
        ...
        tabelaUsuario.getColumnModel().getColumn(10).setPreferredWidth(30);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarClientesJuridicos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarClientesJuridicos().setVisible(true);
            }
        });
    }
